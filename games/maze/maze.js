...
Maze.prototype.generate = function() {
    ...
    let currentNode;
    do {
        currentNode = this.mazeNodeArray[this.random(this.row)][this.random(this.col)];
    ...
    while(currentNode.isVisited) {
        // 得到当前节点的四周节点
        let topNode = this.mazeNodeArray[currentNode.x - 2] ? this.mazeNodeArray[currentNode.x - 2][currentNode.y] : { isVisited: true };
        let rightNode = this.mazeNodeArray[currentNode.x][currentNode.y + 2] ? this.mazeNodeArray[currentNode.x][currentNode.y + 2] : { isVisited: true };
        let bottomNode = this.mazeNodeArray[currentNode.x + 2] ? this.mazeNodeArray[currentNode.x + 2][currentNode.y] : { isVisited: true };
        let leftNode = this.mazeNodeArray[currentNode.x][currentNode.y - 2] ? this.mazeNodeArray[currentNode.x][currentNode.y - 2] : { isVisited: true };
        ...
        if (neighbourArray.length > 0) {
            ...
            this.mazeNodeArray[(neighbourNode.x + currentNode.x) / 2][(neighbourNode.y + currentNode.y) / 2].passable = true;
...
Maze.prototype.findPath = function() {
    ...
    while(q.size() > 0) {
        ...
        // 上
        if (this.mazeNodeArray[startNode.x - 1] && this.mazeNodeArray[startNode.x - 1][startNode.y].passable) {
        ...
        // 右
        if (this.mazeNodeArray[startNode.x][startNode.y + 1] && this.mazeNodeArray[startNode.x][startNode.y + 1].passable) {
